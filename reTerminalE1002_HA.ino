...
int weatherCodeToIcon(int weatherCode) {
    switch (weatherCode) {
        case 0: return 7;      // Sun
        case 1: case 2: return 3;    // Some clouds
        case 3: return 5;      // Cloudy
        case 45: case 48: return 2;  // Fog
        case 51: case 53: case 55: return 6; // Drizzle
        case 56: case 57: return 6;  // Freezing drizzle
        case 61: case 63: case 65: return 1; // Rain
        case 66: case 67: return 6;  // Freezing rain
        case 71: case 73: case 75: case 77: case 85: case 86: return 4; // Snow
        case 80: case 81: case 82: return 6; // Rain showers
        case 95: case 96: case 99: return 0; // Thunderstorm
        default: return 5;
    }
}
...
void displayCurrent(int x, int y, float current, int min, int max, int iconNb) {
    int16_t x1, y1;
    uint16_t w, h;
    display.drawBitmap(x + 30, y + 40, epd_bitmap2_allArray[iconNb], 100, 100, GxEPD_BLACK);
    ...
    display.setCursor(x + 80 - w / 2, y + 160);
    display.print(max, 0);
    display.write(0x60);

    display.getTextBounds(String(min) + "`", 0, 0, &x1, &y1, &w, &h);
    display.setCursor(x + 80 - w / 2, y + 190);
    display.print(min, 0);
    display.write(0x60);
}
...
void loop() {
    ...
    do {
        ...
        displayForecast(330, 100, (today + 1) % 7, D1MinTemp, D1MaxTemp, weatherCodeToIcon(D1Code));
        displayForecast(440, 100, (today + 2) % 7, D2MinTemp, D2MaxTemp, weatherCodeToIcon(D2Code));
        displayForecast(550, 100, (today + 3) % 7, D3MinTemp, D3MaxTemp, weatherCodeToIcon(D3Code));
        displayForecast(660, 100, (today + 4) % 7, D4MinTemp, D4MaxTemp, weatherCodeToIcon(D4Code));
    ...
    Serial1.println("Deep sleep 10min...");
